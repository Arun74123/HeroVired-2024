...
class Q3
{
    ...
    static void addprod(ArrayList<String> pl,ArrayList<ArrayList<String>> pd,ArrayList<Integer> pc)
    {
    ...
    static void viewproddet(ArrayList<String> pl,ArrayList<ArrayList<String>> pd,ArrayList<Integer> pc)
    {

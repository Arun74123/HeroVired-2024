...
class pro{
	...
	String productName;
	pro(String name,String spec,double cost,int count){
		this.cost = cost;
		this.count = count;
...
public class Q4 {
	...
	public static void editproduct(List<pro> list) {
	...
	public static void productdetails(List<pro> list) {
		System.out.println("\nEnter product name : ");
		sc.nextLine();
		String pname = sc.nextLine();
		for(pro p: list) {
	...
	public static void productcount(List<pro> list) {
		System.out.print("\nEnter product name : ");
		sc.nextLine();
		String pname = sc.nextLine();
		boolean f = false;
	...
	public static void productList(List<pro> list) {
		if(list.size() == 0) {
	...
	public static void updateInventory(List<pro> list) {
		System.out.println("-----------------------");
